    ...
    >
      {/* Text */}
        ...
        <p className="text-gray-400 max-w-md text-center">
          ...
          every whim, any time of day or night. She's your loyal cobber, keen as
          a bean to dive deep into your deepest desires, even the most private
          and cheeky ones. Where your wildest fantasies aren't just fair dinkum
          but bloody bonza.
        </p>
        ...
        <div className="flex items-center justify-center gap-4 flex-wrap">
          {SKILLS_LIST.map((skill, i) => (
            <MotionDiv key={skill} {...slideInFromBottom(i / 10)}>
              <SVG
                className="w-28 h-28 relative [&_svg]:absolute [&_svg]:h-20 [&_svg]:w-20 [&_svg]:left-[110%] [&_svg]:top-1/2 [&_svg]:-translate-x-1/2 [&_svg]:-translate-y-1/2 hover:-translate-y-4 transition-transform duration-300"
